 "use client"
import CartItemList, { CardListProps } from '@/app/_components/CartItemList';
...
export default function Checkout() {
  ...
  calculateTotalAmount()
   ...
   // console.log(totalAmount)
    const totals=(subtotal * 9) / 100 + 15 + subtotal
   const amount1=(subtotal * 9) / 100
            ...
            <div className='p-5 px-5 md:px-10 grid grid-cols-1 md:grid-cols-3 py-8'>
                ...
                <div className='mx-10 border'>
                    ...
                    <div className='p-4 flex flex-col gap-4'>
                        ...
                        <hr />
                        <h2 className='flex justify-between'>Delivery:<span>$15.300</span></h2>
                        <h2 className='flex justify-between'>Tax(9%):<span>${amount1.toFixed(2)}</span></h2>
                        <hr />
